...
<details>
  <summary>📖 Pinned Projects & Demos</summary>
  
- **FlightSimEngine** – [Repo](https://github.com/ahanuf/FlightSimEngine) |  
    🛠️ C++ | 🔬 Real‑time physics + Vulkan renderer  
- **CelestialVoyager** – [Repo](https://github.com/ahanuf/CelestialVoyager) |  
    📚 Interactive sci‑fi narrative & galaxy map  
- **LiveStreamDJ** – [Repo](https://github.com/ahanuf/LiveStreamDJ) |  
    📡 Django + WebRTC + Kurento  
- **AIoT-SBC** – [Repo](https://github.com/ahanuf/AIoT-SBC) |  
    🛠️ PCB design, firmware & edge‑inference examples
...
<!---
ahanuf/ahanuf is a ✨ special ✨ repository because its `README.md` (this file) appears on your GitHub profile.
